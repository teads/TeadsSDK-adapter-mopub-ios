...
- (void)requestAdWithSize:(CGSize)size customEventInfo:(NSDictionary * _Null_unspecified)info adMarkup:(NSString * _Null_unspecified)adMarkup;
...
@interface MPAdapterTeadsBanner (SWIFT_EXTENSION(TeadsMoPubAdapter)) <TFAAdDelegate>
...
SWIFT_CLASS("_TtC17TeadsMoPubAdapter26MPAdapterTeadsInterstitial")
@interface MPAdapterTeadsInterstitial : MPInterstitialCustomEvent
- (void)requestInterstitialWithCustomEventInfo:(NSDictionary * _Null_unspecified)info adMarkup:(NSString * _Null_unspecified)adMarkup;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class TFAInterstitialAd;

@interface MPAdapterTeadsInterstitial (SWIFT_EXTENSION(TeadsMoPubAdapter)) <TFAInterstitialAdDelegate>
...
- (void)requestRewardedVideoWithCustomEventInfo:(NSDictionary * _Null_unspecified)info adMarkup:(NSString * _Null_unspecified)adMarkup;
- (BOOL)hasAdAvailable SWIFT_WARN_UNUSED_RESULT;
- (void)presentRewardedVideoFromViewController:(UIViewController * _Null_unspecified)viewController;
...
@interface MPAdapterTeadsRewardedVideo (SWIFT_EXTENSION(TeadsMoPubAdapter)) <TFARewardedAdDelegate>
